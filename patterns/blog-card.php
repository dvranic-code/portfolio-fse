...
/**
 * Title: Blog Card
 * Slug: portfolio-fse/blog-card
 * Categories: portfolio-fse
 * Keywords: blog, card, portfolio, query
...
<div class="wp-block-group has-foreground-muted-color has-text-color has-link-color has-mono-font-family has-small-font-size" style="text-transform:lowercase"><!-- wp:post-date {"format":"Y.m.d" ,"metadata":{"bindings":{"datetime":{"source":"core/post-data","args":{"field":"date"}}}}} /-->
